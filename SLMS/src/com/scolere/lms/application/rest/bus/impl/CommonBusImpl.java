...
public class CommonBusImpl implements CommonBusIface{
    ...
    public CommonResponse getFeedsList(CommonRequest req) throws RestBusException {
        ...
        try{
         ...
         List<CommentVO> commentListDB = service.getFeedCommentsList(vo.getFeedID(),req.getUserId());
         ...
         for(CommentVO cvo : commentListDB)
         {
             ...
             crto.setCommentByImage(cvo.getCommentByImage());
         ...
         List<CommentVO> childCommentListDB = service.getFeedChildCommentsList(cvo.getCommentId(),req.getUserId());
         List<CommentRespTO> childCommentsList = new ArrayList<CommentRespTO>(childCommentListDB.size());
	         for(CommentVO cvo2 : childCommentListDB)
	         {
	        	 ...
	        	 childCrto.setCommentByImage(cvo2.getCommentByImage());
    ...
    public CommonResponse getUserDetail(int userId) throws RestBusException {
        ...
        if(userFromDB != null)
        {
         ...
         user.setAdminEmailId(user.getAdminEmailId());
         user.setProfileImage(userFromDB.getProfileImage());
         user.setSchoolId(String.valueOf(userFromDB.getSchoolId()));
         user.setSchoolName(userFromDB.getSchoolName());
         user.setHomeRoomId(String.valueOf(userFromDB.getHomeRoomId()));
         user.setHomeRoomName(userFromDB.getHomeRoomName());
         user.setClassId(String.valueOf(userFromDB.getClassId()));
         user.setClassName(userFromDB.getClassName());
