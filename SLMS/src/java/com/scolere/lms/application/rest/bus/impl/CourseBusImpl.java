...
public class CourseBusImpl implements CourseBusIface{
    ...
    public CourseResponse getModuleDetailsByFeedId(int feedId) throws RestBusException {
        ...
        try{
            ...
            //Assignment start >>
            List<AssignmentVO> assgnmentsFromDb = service.getStudentAssignments(1);//Need to get assignments on the basis of moduleId
            ...
            List<ResourseVO> attachedResourcesFromDB=service.getAssignmentsResources(1, vo4.getAssignmentId()); //Need to remove first parameter
   ...
   // related videos    
	...
	public int saveResourceProfile(String resourceprofileImgName,
        ...
        try {
            ...
            if(resourceprofileImgName != null && !resourceprofileImgName.isEmpty())
            {
                status = service.saveResourceProfile(resourceprofileImgName,resourceAuthor,resourceImage,lastUserIdCd,descTxt,resourceName,upLoadUrl,resoUrl);
